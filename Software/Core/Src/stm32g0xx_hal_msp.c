...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspInit 0 */
    ...
    PA5     ------> DAC1_OUT2
    */
    GPIO_InitStruct.Pin = DAC_A_Pin|DAC_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspDeInit 0 */
    ...
    PA5     ------> DAC1_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, DAC_A_Pin|DAC_B_Pin);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PB14     ------> I2C2_SDA
    */
    GPIO_InitStruct.Pin = SCL_A_Pin|SDA_A_Pin;
  ...
  /* USER CODE END I2C3_MspInit 0 */
    ...
    PA7     ------> I2C3_SCL
    */
    GPIO_InitStruct.Pin = SDA_B_Pin|SCL_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB14     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(SCL_A_GPIO_Port, SCL_A_Pin);

    HAL_GPIO_DeInit(SDA_A_GPIO_Port, SDA_A_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PA7     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(SDA_B_GPIO_Port, SDA_B_Pin);

    HAL_GPIO_DeInit(SCL_B_GPIO_Port, SCL_B_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB9     ------> SPI2_NSS
    */
    HAL_GPIO_DeInit(GPIOB, MOSI_Pin|SCK_Pin|CS_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOC, ENC2_Pin|ENC1_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PA10     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = TX_A_Pin|RX_A_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END USART5_MspInit 0 */
    ...
    PB1     ------> USART5_RX
    */
    GPIO_InitStruct.Pin = TX_B_Pin|RX_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, TX_A_Pin|RX_A_Pin);
  ...
  /* USER CODE END USART5_MspDeInit 0 */
    ...
    PB1     ------> USART5_RX
    */
    HAL_GPIO_DeInit(GPIOB, TX_B_Pin|RX_B_Pin);
